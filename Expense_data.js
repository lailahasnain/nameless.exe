...
function pull_data_Expenses(email_front)
{
    ...
    ref.on('value', snapshot => {
        ...
        disp_Expenses(Air_price, Air, Dep, Hot, Hot_Price, Loc, Nickname, Ret, Sub_Tot, Taxes, Tot, Trans, Trans_price, user_email)
    });
}
...
function update_email_send() {
    ...
    if (up == "") {
        ...
        // Send email
        send_email(email_un, Nickname, h_n, Hot_Price, Air, Air_price, Trans, Trans_price, user_email, h_url, h_n, Dep_d, Dep_t, Ret_d, Ret_t, Taxes, Sub_Tot, Tot, Loc);
    }
    else if (up == "No") {
